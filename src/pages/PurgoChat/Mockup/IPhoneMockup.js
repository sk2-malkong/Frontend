        ...
        <div className="relative w-auto h-auto" style={{ transform: "scale(0.7)" }}>
            <svg width="427" height="858" viewBox="0 0 427 858" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0_1830_162)">
                    ...
                    <mask id="mask0_1830_162" style={{maskType: "alpha"}} maskUnits="userSpaceOnUse" x="26" y="23" width="375" height="812">
                    ...
                    {/* 흰색 화면 영역 - 여기에 앱 컨텐츠를 포함할 foreignObject를 추가 */}
                ...
                <defs>
                    <filter id="filter0_dd_1830_162" x="-1" y="-2" width="429" height="866" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
